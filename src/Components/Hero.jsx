      ...
      <div className="mx-auto max-w-7xl px-8 grid md: grid-cols-2 items-center gap-8">
        <article>
          ...
          <div className="flex gap-x-4 mt-4">
            ...
            <a
              href="https://mail.google.com/mail/?view=cm&fs=1&to=yohanneskefelegnn@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              <BiLogoGmail className="h-8 w-8 text-slate-500 hover:text-black transition-colors duration-300" />
            </a>
          </div>
        </article>
